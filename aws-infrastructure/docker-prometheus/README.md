...
```
docker tag prometheus-custom 202533525871.dkr.ecr.eu-central-1.amazonaws.com/monitoring:prometheus
```

```
docker push 202533525871.dkr.ecr.eu-central-1.amazonaws.com/monitoring:prometheus
```